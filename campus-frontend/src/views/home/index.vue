...
import { Bottom, ChatDotRound, CloseBold, Delete, Document, Plus, Promotion, Search, TopRight, WarningFilled } from '@element-plus/icons-vue'
import { ElMessage } from 'element-plus'
import { deleteConversation, getConversation, listConversations } from '@/api/qa'
import { streamChat, type SSEEvent } from '@/utils/sse'
import { useUserStore } from '@/stores/user'
import type { ActiveChatStream, ChatMessage, Conversation, SourceRef } from '@/types'
...
function answerOrigin(value: unknown): ChatMessage['answer_origin'] | undefined {
  return value === 'KNOWLEDGE_BASE' || value === 'WEB_SEARCH' || value === 'NO_ANSWER' ? value : undefined
}
...
onBeforeUnmount(stopCurrentStream)
</script>
